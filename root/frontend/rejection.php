                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-12" style="margin-top:80px">
                        <div class="mb-5 text-left">
                            <h1 class="text-white font-weight-bold">Απόρριψη Αίτησης</h1>
                            <div class="custom-breadcrumbs">
                                ...
                                <span class="text-white"><strong>Απόρριψη Αίτησης</strong></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <form class="p-4 p-md-5 border rounded" method="post">
                            <h3 class="text-black mb-5 border-bottom pb-2">Απόρριψη</h3>

                            <div class="form-group">
                                <label for="job-description">Λόγος απόρριψης</label>
                ...
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-lg-4 ml-auto">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <a href="#" class="btn btn-block btn-outline-red btn-md" style="width: 180px; position: absolute; right: 15px;">Οριστική απόρριψη</a>
                            </div>
                        </div>
                    </div>
                </div>
