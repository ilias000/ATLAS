                  ...
                  <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                      ...
                      <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
                          ...
                          <div class="job-listing-meta">
                            <span class="saved-jobes-boxes"><strong>Κατάσταση: </strong>Υποβληθείσα <strong class="second">Εγκεκριμένη</strong></span>
                          </div>
                          <div class="saved-jobes-buttons">
                            <button class="first" type="button">Προεπισκόπιση</button>
                            <button class="second" type="button">Ιδιωτικό Συμφωνητικό</button>
                        </div>
                        </div>
