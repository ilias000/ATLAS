...
<body id="top">
  ...
  <div class="loader">
    <div class="spinner-border text-primary" role="status"><span class="sr-only">Φόρτωση...</span></div>
  </div>
  <div class="site-wrap">
              ...
              <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
                ...
                <li class="has-children"><a href="#">Βοήθεια</a>
                  <ul class="dropdown">
                    ...
                    <li><a href="./faqCompany.php?loggedIn=true">Είμαι Φορέας Υποδοχής</a></li>
                  </ul>
                </li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs"><a href="index.php">Αρχική</a><span class="mx-2 slash">/</span><span class="text-white"><strong>Φόρμα Επικοινωνίας</strong></span></div>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-lg-6 mb-5 mb-lg-0 ContactForm">
            <form action="#" class="">
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0"><label class="text-black" for="fname">Όνομα</label><input type="text" id="fname" class="form-control"></div>
                <div class="col-md-6"><label class="text-black" for="lname">Επώνυμο</label><input type="text" id="lname" class="form-control"></div>
              </div>
              <div class="row form-group">
                <div class="col-md-12"><label class="text-black" for="email">Ηλεκτρονική Διεύθυνση</label><input type="email" id="email" class="form-control"></div>
              </div>
              <div class="row form-group">
                <div class="col-md-12"><label class="text-black" for="subject">Θέμα</label><input type="subject" id="subject" class="form-control"></div>
              </div>
              <div class="row form-group">
                <div class="col-md-12"><label class="text-black" for="message">Μήνυμα</label><textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Γράψτε τη σημείωση ή την ερώτησή σας εδώ..."></textarea></div>
              </div>
              <div class="row form-group">
                <div class="col-md-12"><input type="submit" value="Αποστολή" class="btn btn-primary btn-md text-white" style="width: 100%;"></div>
              </div>
            </form>
          </div>
        </div>
